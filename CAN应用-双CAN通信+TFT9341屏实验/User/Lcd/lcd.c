...
//Gui_StrCenter(0,46,RED,BLUE,"嵌入式系统原理及应用配套实验板",16,1);//居中显示
	Gui_StrCenter(0,100,RED,WHITE,"   CAN通信实验测试程序     ",16,0);//居中显示	
	Gui_StrCenter(0,130,YELLOW,BLACK," CAN1发送的数据 ",16,0);//居中显示
	Gui_StrCenter(0,170,YELLOW,BLACK," CAN2发送的数据 ",16,0);//居中显示
	Gui_StrCenter(0,150,RED,GREEN," 按KEY1键,CAN1发送,CAN2接收 ",16,0);//居中显示
	Gui_StrCenter(0,190,RED,GREEN," 按KEY2键,CAN2发送,CAN1接收 ",16,0);//居中显示
	Gui_StrCenter(0,210,YELLOW,BLACK,"CAN1接收的数据:",16,0);//居中显示
	Gui_StrCenter(0,250,YELLOW,BLACK,"CAN2接收的数据:",16,0);//居中显示
