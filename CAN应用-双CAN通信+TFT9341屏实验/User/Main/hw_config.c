...
void BUTTON_Configuration(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_11 | GPIO_Pin_12;//KEY1=PD11.KEY2=PD12
	GPIO_Init(GPIOD, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13 ;//KEY3=PC13
...
*功能说明：USART2 发送字符串
**********************************************/
void USART2_SendByte(uint8_t dat)
{
		while(!USART_GetFlagStatus(USART2, USART_FLAG_TXE));
