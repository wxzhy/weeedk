...
void Welcome(void)
{
			DrawTestPage("DAC应用-软件触发变换测试实验");
			Gui_StrCenter(0,40,BRED,YELLOW,"南航 NUAA_CM3_107 KIT",16,0);//居中显示
	if (USE_HORIZONTAL==1)	Show_Str(85,65,GREEN,BLACK,"嵌入式系统实验",24,1);
	else					Show_Str(30,65,GREEN,BLACK,"嵌入式系统实验",24,1);
	Gui_StrCenter(0,100,RED,WHITE,"  DAC由ADC控制输出大小  ",16,0);//居中显示	
	
	Show_Str(20,140,YELLOW,BLACK,"电位器电压值",16,0);	
	Show_Str(20,165,YELLOW,BLACK,"PT100 温度值",16,0);	
	Show_Str(20,190,YELLOW,BLACK,"水位深度之值",16,0);	
	Show_Str(20,215,YELLOW,BLACK,"内部温度之值",16,0);	
	Show_Str(20,240,YELLOW,BLACK,"内部基准电压",16,0);	

	Show_Str(200,140,YELLOW,BLACK,"mV",16,0);	
	Show_Str(200,165,YELLOW,BLACK,"℃",16,0);	
	Show_Str(200,190,YELLOW,BLACK,"mm",16,0);	
	Show_Str(200,215,YELLOW,BLACK,"℃",16,0);	
	Show_Str(200,240,YELLOW,BLACK,"mV",16,0);	
