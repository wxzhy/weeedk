...
//Gui_StrCenter(0,46,RED,BLUE,"嵌入式系统原理及应用配套实验板",16,1);//居中显示
	Gui_StrCenter(0,100,RED,WHITE,"   I2C AT24C02实验测试程序   ",16,0);//居中显示	
	Gui_StrCenter(0,130,YELLOW,BLACK,"写入的EEPROM数据:",16,0);//居中显示
	Gui_StrCenter(0,170,YELLOW,BLACK,"读出的EEPROM数据:",16,0);//居中显示
	Gui_StrCenter(0,150,WHITE,RED,"   按KEY1,KEY2写入数据     ",16,0);//居中显示
	Gui_StrCenter(0,190,WHITE,RED,"   按KEY3读出数据     ",16,0);//居中显示
}
