...
void Welcome(void)
{
	...
	Gui_StrCenter(0,130,WHITE,BLACK,"连蓝牙模块到实验板J21",16,0);//居中显示
	Gui_StrCenter(0,150,YELLOW,BLACK,"打开手机蓝牙助手",16,0);//居中显示
	Gui_StrCenter(0,170,YELLOW,BLACK,"按照通信协议发01命令",16,0);//居中显示
	Gui_StrCenter(0,190,YELLOW,BLACK,"查看手机蓝牙助手接收到的信息",16,0);//居中显示
	Gui_StrCenter(0,210,YELLOW,BLACK,"通过蓝牙接收的命令:",16,0);//居中显示
