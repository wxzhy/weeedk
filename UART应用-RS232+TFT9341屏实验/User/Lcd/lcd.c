...
void Welcome(void)
{
	DrawTestPage("UART应用-RS232实验测试程序");
...
//Gui_StrCenter(0,46,RED,BLUE,"嵌入式系统原理及应用配套实验板",16,1);//居中显示
	Gui_StrCenter(0,100,RED,YELLOW,"UART-RS232通信实验测试程序",16,0);//居中显示	
	Gui_StrCenter(0,130,WHITE,BLACK,"连RS-232,USB-UART到PC机",16,0);//居中显示
	Gui_StrCenter(0,150,YELLOW,BLACK,"打开PC上的串口助手",16,0);//居中显示
	Gui_StrCenter(0,170,YELLOW,BLACK,"依次按KEY1、KEY2、KEY3和KEY4",16,0);//居中显示
	Gui_StrCenter(0,190,YELLOW,BLACK,"查看PC串口助手接收到的信息",16,0);//居中显示
	Gui_StrCenter(0,210,YELLOW,BLACK,"通过RS232接收的命令:",16,0);//居中显示
