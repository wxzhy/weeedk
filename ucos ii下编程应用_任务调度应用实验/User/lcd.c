...
void Welcome(void)
{
			DrawTestPage("uC/OS-II下的任务调度实验");
			Gui_StrCenter(0,100,RED,YELLOW,"uC/OS-II下的任务调度实验",16,0);//居中显示	
	
	Gui_StrCenter(0,130,RED,YELLOW,"       uC/OS-II 4个任务       ",16,0);//居中显示
	
	Show_Str(40,150,WHITE,BLACK,"任务1:采集电位器电压",16,0);
	Show_Str(40,170,WHITE,BLACK,"任务2:蜂鸣器控制",16,0);
	Show_Str(40,190,WHITE,BLACK,"任务3:PWM控制电机",16,0);
	Show_Str(40,210,WHITE,BLACK,"任务4:LCD显示测量结果",16,0);
	Show_Str(40,230,WHITE,BLACK,"A/D变换的结果 : ",16,0);
	Show_Str(40,250,WHITE,BLACK,"测量电压(mV)为: ",16,0);
	Gui_StrCenter(0,270,RED,GREEN,"   转动电位器看电机运行情况   ",16,0);
