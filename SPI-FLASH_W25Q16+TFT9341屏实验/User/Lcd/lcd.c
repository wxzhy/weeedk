...
//Gui_StrCenter(0,46,RED,BLUE,"嵌入式系统原理及应用配套实验板",16,1);//居中显示
	Gui_StrCenter(0,100,RED,WHITE," SPI Flash W25Q16实验测试程序 ",16,0);//居中显示	
	Gui_StrCenter(0,130,YELLOW,BLACK,"写入Flash中的数据:",16,0);//居中显示
	Gui_StrCenter(0,170,YELLOW,BLACK,"读出Flash中的数据:",16,0);//居中显示
	Gui_StrCenter(0,150,WHITE,RED,"   按KEY1写入数据     ",16,0);//居中显示
	Gui_StrCenter(0,190,WHITE,RED,"   按KEY2读出数据     ",16,0);//居中显示
	Gui_StrCenter(0,230,WHITE,RED,"  按KEY3擦除0号扇区   ",16,0);//居中显示
}
