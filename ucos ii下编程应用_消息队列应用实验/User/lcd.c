...
void Welcome(void)
{
			DrawTestPage("uC/OS-II下的消息队列实验");
			Gui_StrCenter(0,100,RED,YELLOW,"uC/OS-II下的消息队列实验",16,0);//居中显示	
	
	Gui_StrCenter(0,130,RED,YELLOW,"   uC/OS-II初始化过程   ",16,0);//居中显示

	Gui_StrCenter(0,150,YELLOW,BLACK,"建立消息队列",16,0);//居中显示
	Gui_StrCenter(0,170,YELLOW,BLACK,"清空消息队列",16,0);//居中显示
	Gui_StrCenter(0,190,YELLOW,BLACK,"创建多个任务",16,0);//居中显示
	Gui_StrCenter(0,210,YELLOW,BLACK,"启动任务调度",16,0);//居中显示
	Gui_StrCenter(0,230,WHITE,BLACK,"  查看LED1和LED2显示情况 ",16,0);//居中显示					
	Gui_StrCenter(0,250,WHITE,RED,"查看串口助手接收的提示信息",16,0);//居中显示					
