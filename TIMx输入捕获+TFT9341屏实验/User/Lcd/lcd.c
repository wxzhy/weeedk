...
//Gui_StrCenter(0,46,RED,BLUE,"嵌入式系统原理及应用配套实验板",16,1);//居中显示
	Gui_StrCenter(0,100,YELLOW,BLACK,"TIMx输入捕获实验测试程序",16,0);//居中显示	
	Gui_StrCenter(0,130,WHITE,BLACK,"TIM2输入捕获低电平时间(us)",16,0);//居中显示	
	 POINT_COLOR=YELLOW;
	 BACK_COLOR =RED;
	LCD_ShowNum(80,160,0,8,16);
}
