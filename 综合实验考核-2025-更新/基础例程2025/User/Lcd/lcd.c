...
void Welcome(void)
{
	...
	Show_Str(20,190,WHITE,BLACK,"水位深度之值",16,0);	
	Show_Str(20,215,WHITE,BLACK,"内部温度之值",16,0);	
	Show_Str(20,240,WHITE,BLACK,"内部基准电压",16,0);	
	...
	Gui_StrCenter(0,273,RED,YELLOW,"ADC-DMA多通道实验测试结果",16,0);//居中显示	
...
{	
	...
	Show_Str(20,270,WHITE,BLACK,"PWM占空比",16,0);	
	Show_Str(200,270,WHITE,BLACK,"%",16,0);	

POINT_COLOR =YELLOW;BACK_COLOR =RED; 
	LCD_DrawRectangle(0,230,240,295);
	POINT_COLOR =RED;
	LCD_DrawRectangle(1,231,238,294);
	POINT_COLOR =YELLOW;
	LCD_DrawRectangle(2,232,237,293);
