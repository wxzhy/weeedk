...
void GPIO_Configuration(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = LED5_PIN|IA_PIN|IB_PIN;
	GPIO_Init(GPIOB, &GPIO_InitStructure);
...
/*********************************************
*函数名称：void USART_RS485Configuration(void)
*
*入口参数：无
*
*出口参数：无
*
*功能说明：USART2 (RS-485)初始化配置 包括GPIO初始化 TX必须配置为复用输出
**********************************************/
void USART_RS485Configuration(u32 UART2_Baud)
{
	GPIO_InitTypeDef  GPIO_InitStructure;
