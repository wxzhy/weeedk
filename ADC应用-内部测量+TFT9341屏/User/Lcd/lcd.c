...
//Gui_StrCenter(0,46,RED,BLUE,"嵌入式系统原理及应用配套实验板",16,1);//居中显示
	Gui_StrCenter(0,100,YELLOW,BLUE,"欢迎使用内部通道测试示例!",16,0);//居中显示
	Gui_StrCenter(0,130,WHITE,BLACK," 测量内部温度传感器的数字量为 ",16,0);//居中显示
	Gui_StrCenter(0,170,WHITE,BLACK,"     测量内部温度值为    ",16,0);//居中显示
	Gui_StrCenter(0,210,WHITE,BLACK," 测量内部基准数字量为 ",16,0);//居中显示
	Gui_StrCenter(0,250,WHITE,BLACK," 测量内部基准电压为 ",16,0);//居中显示
		BACK_COLOR=RED;
		POINT_COLOR=WHITE;
}
