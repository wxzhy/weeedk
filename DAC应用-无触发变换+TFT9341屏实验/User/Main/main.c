...
4.本实验例程现象说明内容：  
	DAC应用：采用无触发方式进行D/A变换,由ADC采集的大小控制DAC输出大小
	电位器中心点电压采样之后送DACOUT1（PA4）输出，当连接PA4到IA或IB时将直接通过电位器电压大小控制电机转速快慢。
**************************************************************************************************/	
...
int main(void)
{
	...
	{		
		...
		DAC_SetChannel1Data(DAC_Align_12b_R, value);/*将等变换的DAC数据放右对齐寄存器中*/
